...
contract('Dex', (accounts) => {
  ...
  describe('createLimitOrder', () => {
    it('should create limit order', async () => {
      ...
      assert(buyOrders[0].amount === web3.utils.toWei('100'));
    ...
    it('should NOT create limit order if the balance is too low', async () => {
    ...
    it('should NOT create limit order if the DAI balance is too low', async () => {
  ...
  describe('createMarketOrder', () => {
    it('should create market order and match again existing limit order', async () => {
      await dex.deposit(web3.utils.toWei('100'), DAI, {
        from: trader1,
      });
    ...
    it('should NOT create market order if the balance is too low', async () => {
      await dex.deposit(web3.utils.toWei('99'), REP, {
        from: trader1,
      });
